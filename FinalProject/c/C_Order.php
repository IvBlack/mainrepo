...
class C_Order extends C_Base
{
	...
	public function action_add()	{
		...
		if($_SESSION['order_id']){
			...
			$text .= "<h2>Спасибо за покупку! Ваш Заказ № ".$_SESSION['order_id']." оформлен. Вы получите инструкции на эл/почту.</h2>";
			...
			$text .= "<br><p>Заказ оформлен на ".$_POST['username']." e-mail: ".$_POST['useremail']." Телефон ".$_POST['usertel']."<br>";
