...
class C_Basket extends C_Base
{
	...
	public function action_del()	{
		...
		if($delbasket->basketdel($_POST["idbasket"])){
			$text .= "<div class='col-12'>Товар успешно удален
            <form method='post' action='index.php?c=basket&act=view'><div class='form-group'><button class='btn btn-primary' type='submit'>Вернуться в Корзину</button></div>
            </form>
            </div>";
		}
		$this->content = $this->Template('v/v_basket.php', array('text' => $text));	 		
